...
bool CustomListBoxPlayerSelectionMultiple(const char* label, std::vector<std::pair<PlayerSelection, bool>>* list, float width, ImGuiComboFlags flags = ImGuiComboFlags_None);

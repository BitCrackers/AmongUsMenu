...
<<<<<<< HEAD
	const auto& versionText = std::format("<size=75%>{} ~ <#0f0>SickoMode</color><#f00>AU</color> <#0f0>v1.1</color></size>",
||||||| 71a6a7a
	const auto& versionText = std::format("<size=75%>{} ~ <#0f0>SickoMode</color><#f00>AU</color> v1.0_pr2</size>",
=======
	const auto& versionText = std::format("<size=75%>{} ~ <#0f0>SickoMode</color><#f00>AU</color> v1.0</size>",
>>>>>>> 97f14d58563c8085708e2d727bff7e08ac54870b
...
=======
	std::string pingText = std::format("{}\n<#0f0>SickoMode</color><#f00>AU</color> v1.0{}{}{}", ping, noClip, freeCam, spectating);
>>>>>>> 97f14d58563c8085708e2d727bff7e08ac54870b

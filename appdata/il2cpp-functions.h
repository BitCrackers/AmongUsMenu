...
DO_APP_FUNC(GameOptionsData*, GameOptionsData_Deserialize, (BinaryReader* reader, MethodInfo* method), "Assembly-CSharp, AmongUs.GameOptions.GameOptionsData AmongUs.GameOptions.GameOptionsData::Deserialize(System.IO.BinaryReader)");
...
DO_APP_FUNC(void, LogicRoleSelectionNormal_AssignRolesForTeam, (List_1_GameData_PlayerInfo_* players, IGameOptions* opts, RoleTeamTypes__Enum team, int32_t teamMax, Nullable_1_RoleTypes_ defaultRole, MethodInfo* method), "Assembly-CSharp, System.Void LogicRoleSelectionNormal::AssignRolesForTeam(System.Collections.Generic.List<GameData.PlayerInfo>, AmongUs.GameOptions.IGameOptions, RoleTeamTypes, System.Int32, System.Nullable<AmongUs.GameOptions.RoleTypes>)");
DO_APP_FUNC(void, LogicRoleSelectionNormal_AssignRolesFromList, (List_1_GameData_PlayerInfo_* players, int32_t teamMax, List_1_RoleTypes_* roleList, int32_t* rolesAssigned, MethodInfo* method), "Assembly-CSharp, System.Void LogicRoleSelectionNormal::AssignRolesFromList(System.Collections.Generic.List<GameData.PlayerInfo>, System.Int32, System.Collections.Generic.List<AmongUs.GameOptions.RoleTypes>, System.Int32&)");
...
// deprecated
DO_APP_FUNC(String*, LegacySaveManager_get_PlayerName, (MethodInfo* method), "Assembly-CSharp, System.String AmongUs.Data.Legacy.LegacySaveManager::get_PlayerName()");
// deprecated
DO_APP_FUNC(void, LegacySaveManager_set_PlayerName, (String* value, MethodInfo* method), "Assembly-CSharp, System.Void AmongUs.Data.Legacy.LegacySaveManager::set_PlayerName(System.String)");
// deprecated
DO_APP_FUNC(bool, LegacySaveManager_GetPurchase, (String* itemKey, String* bundleKey, MethodInfo* method), "Assembly-CSharp, System.Boolean AmongUs.Data.Legacy.LegacySaveManager::GetPurchase(System.String, System.String)");
